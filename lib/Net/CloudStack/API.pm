...
=for :stopwords API Alan Allocatin AsyncQuery BackedUp BackingUp BareMetal CIDR CIFS CloudIdentifier CloudManaged CloudStack DATADISK
DNS Destroyes DiskOffering ExternalDhcp ExternalFirewall ExternalLoadBalancer ExternalManaged FIXME GuestOS HVM Hyperv Hypervisor
ICMP IP IPAddress IQN ISOs Ip JSESSIONID KVM LUN LoadBalancer Mhz NetAppIntegration NetworkDevices NetworkOffering PxeServer QCOW
SSHKeyPair SecurityGroup ServiceOffering StoragePools SystemCapacity SystemVM TCP TrafficMonitor UDP UI UTC Username VHD VID VLAN VM
VMGroup VMs VMware VPN Vlan Vm XenServer Young accountName accountid accounttype activeviewersessions addCluster addExternalFirewall
addExternalLoadBalancer addHost addNetworkDevice addSecondaryStorage addTrafficMonitor addVpnUser aggregatename allocatedonly
allocationstate api apikey assignToLoadBalancerRule assigneddate associateIp associateIpAddress associateLun associatednetworkid
asychronous async attachIso attachVolume attahed authorizeSecurityGroupIngress availablility averageload balancer baremetal belongig
boolean bootable broadcastdomaintype broadcasturi cancelHostMaintenance cancelStorageMaintenance capacitytotal capacityused
changeServiceForRouter changeServiceForVirtualMachine checksum cidr cidrlist cleanuprequred cloudidentifier cloudstack
cloudstackversion clusterId clusterid clustername clustertype cmd consoleproxy copyIso copyTemplate count's cpu cpuallocated
cpunumber cpuspeed cpuused cpuwithoverprovisioning createAccount createConfiguration createDiskOffering createDomain
createFirewallRule createInstanceGroup createIpForwardingRule createLoadBalancerRule createLunOnFiler createNetwork createPod
createPool createPortForwardingRule createRemoteAccessVpn createSSHKeyPair createSecurityGroup createServiceOffering createSnapshot
createSnapshotPolicy createStoragePool createTemplate createUser createVlanIpRange createVolume createVolumeOnFiler createZone
crossZones defaultuse deleteAccount deleteCluster deleteDiskOffering deleteDomain deleteExternalFirewall deleteExternalLoadBalancer
deleteFirewallRule deleteHost deleteInstanceGroup deleteIpForwardingRule deleteIso deleteLoadBalancerRule deleteNetwork
deleteNetworkDevice deletePod deletePool deletePortForwardingRule deleteRemoteAccessVpn deleteSSHKeyPair deleteSecurityGroup
deleteServiceOffering deleteSnapshot deleteSnapshotPolicies deleteStoragePool deleteTemplate deleteTrafficMonitor deleteUser
deleteVlanIpRange deleteVolume deleteZone deployVirtualMachine destroyLunOnFiler destroyRouter destroySystemVm destroyVirtualMachine
destroyVolumeOnFiler destzoneid detachIso detachVolume deviceId deviceid dhcp dhcpprovider disableAccount disableStaticNat
disableUser disableed disassociateIpAddress diskOfferingId diskofferingdisplaytext diskofferingid diskofferingname disksize
disksizeallocated disksizetotal displayname displaytext dissociateLun dns dnssearchorder domainID domainId domainid domainname
domainrouter domainsuffix enableAccount enableStaticNat enableStorageMaintenance enableUser encryptedpassword enddate endip endport
entrytime explicitely extractId extractIso extractMode extractTemplate extractVolume firewallRuleUiEnabled firstname firwall
forcedestroylocalstorage forloadbalancing forvirtualnetwork fowarding generateUsageRecords getCloudIdentifier getVMPassword groupid
guestcidraddress guestipaddress guestiptype guestmacaddress guestnetmask guestnetworkid guestosid haenable hasEnoughCapacity
haschild hasing hostId hostid hostname hosttags hypervisor hypervisors hypervisortype icmp icmpcode icmptype inline internaldns
intervaltype ip ipToNetworkList ipaddress ipaddressid ipavailable iplimit iprange ips ipsec iptonetworklist iptotal iqn
iscleanuprequired iscustomized isdefault isextractable isfeatured islocalstorageactive iso isodisplaytext isofilter isoid isoname
isos ispublic isready isrecursive isredundantrouter isshared issourcenat isstaticnat issystem jobid jobinstanceid jobinstancetype
jobltcode jobprocstatus jobresult jobresultcode jobresulttype jobstatus keypair keypairs lastname lastpinged leastconn limitcpuuse
linklocalip linklocalmacaddress linklocalnetmask linklocalnetworkid listAccounts listAlerts listAsyncJobs listCapabilities
listCapacity listClusters listConfigurations listDiskOfferings listDomainChildren listDomains listEventTypes listEvents
listExternalFirewalls listExternalLoadBalancers listFirewallRules listHosts listHypervisors listInstanceGroups listIpForwardingRules
listIsoPermissions listIsos listLoadBalancerRuleInstances listLoadBalancerRules listLunsOnFiler listNetworkDevice
listNetworkOfferings listNetworks listOsCategories listOsTypes listPods listPools listPortForwardingRules listPublicIpAddresses
listRemoteAccessVpns listResourceLimits listRouters listSSHKeyPairs listSecurityGroups listServiceOfferings listSnapshotPolicies
listSnapshots listStoragePools listSystemVms listTemplatePermissions listTemplates listTrafficMonitors listUsageRecords listUsers
listVirtualMachines listVlanIpRanges listVolumes listVolumesOnFiler listVpnUsers listZones loadbalancer login logout lun
managedstate managementserverid maxconnections maxsnaps memoryallocated memorytotal memoryused migrateSystemVm migrateVirtualMachine
modifyPool monthy nat netmask netowrk networkIds networkdeviceparameterlist networkdevicetype networkdomain networkid networkids
networkkbsread networkkbswrite networkofferingavailability networkofferingdisplaytext networkofferingid networkofferingname
networkrate networktype newname nics numretries offerha offeringid ommited openfirewall oscategoryid oscategoryname ostypeid
ostypename pagesize parentdomainid parentdomainname parentid passwordenabled percentused podid podname policyid poolname
prepareHostForMaintenance prepareTemplate preshared presharedkey privateendport privateinterface privateip privatekey
privatemacaddress privatenetmask privateport privatezone priviledged publicendport publicinterface publicip publicipid publickey
publicmacaddress publicnetmask publicnetworkid publicport publicself publiczone queryAsyncJobResult querystring rawusage
rebootRouter rebootSystemVm rebootVirtualMachine receivedbytes reconnectHost recoverVirtualMachine redundantstate registerIso
registerSSHKeyPair registerTemplate registerUserKeys releaseddate removeFromLoadBalancerRule removeVpnUser requireshvm requres
resetPasswordForVirtualMachine resourceType resourcecount resourcetype restartNetwork revokeSecurityGroupIngress rootdeviceid
rootdevicetype roundrobin ruleid secondarystoragevm secretkey securityGroupName securitygroupenabled securitygroupid
securitygroupids securitygroupname securitygroupnames securitygroupsenabled selfexecutable sentbytes serviceofferingdisplaytext
serviceofferingid serviceofferingname sessionkey snapshotId snapshotavailable snapshotid snapshotlimit snapshotpolicy
snapshotreservation snapshottotal snapshottype sourcetemplateid sourcezoneid specied specifyvlan startIP startRouter startSystemVm
startVirtualMachine startdate startip startport stopRouter stopSystemVm stopVirtualMachine storageid storagetype supportELB systemvm
systemvmtype targetiqn templateId templateavailable templatedisplaytext templatefilter templateid templatelimit templatename
templatetag templatetotal templatetype timezoneoffset traffictype updateAccount updateCluster updateConfiguration updateDiskOffering
updateDomain updateHost updateHostPassword updateInstanceGroup updateIso updateIsoPermissions updateLoadBalancerRule updateNetwork
updateNetworkOffering updatePod updateResourceCount updateResourceLimit updateServiceOffering updateTemplate
updateTemplatePermissions updateUser updateVirtualMachine updateZone uploadCustomCertificate uploadpercentage uri url usageid
usageinterface usagetype userApiKey userID userSecretKey userapikey userdata userid username userpublictemplateenabled usersecretkey
usersecuritygrouplist versa virtualmachinedisplayname virtualmachineid virtualmachineids virtualmachinename virutal vlan vlanid
vlanname vlans vm vm's vmavailable vmdisplayname vmlimit vmname vmrunning vms vmstate vmstopped vmtotal volumeId volumeavailable
volumeid volumelimit volumename volumetotal volumetype vpn vpns yyyy zoneId zoneid zonename zonetoken
