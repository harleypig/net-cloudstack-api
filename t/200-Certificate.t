##############################################################################
# This test file tests the functions found in the Certificate section.
...
$tests++;                              # Test loading of Certificate group
...
timeit { ok( eval "use Net::CloudStack::API ':Certificate'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
