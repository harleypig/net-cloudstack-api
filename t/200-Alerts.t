##############################################################################
# This test file tests the functions found in the Alerts section.
...
$tests++;                              # Test loading of Alerts group
...
timeit { ok( eval "use Net::CloudStack::API ':Alerts'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
