##############################################################################
# This test file tests the functions found in the DiskOffering section.
...
$tests++;                              # Test loading of DiskOffering group
...
timeit { ok( eval "use Net::CloudStack::API ':DiskOffering'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
