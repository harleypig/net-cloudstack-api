##############################################################################
# This test file tests the functions found in the Registration section.
...
$tests++;                              # Test loading of Registration group
...
timeit { ok( eval "use Net::CloudStack::API ':Registration'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
