##############################################################################
# This test file tests the functions found in the Other section.
...
$tests++;                              # Test loading of Other group
...
timeit { ok( eval "use Net::CloudStack::API ':Other'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
