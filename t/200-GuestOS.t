##############################################################################
# This test file tests the functions found in the GuestOS section.
...
$tests++;                              # Test loading of GuestOS group
...
timeit { ok( eval "use Net::CloudStack::API ':GuestOS'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
