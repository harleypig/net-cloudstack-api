##############################################################################
# This test file tests the functions found in the ExternalFirewall section.
...
$tests++;                              # Test loading of ExternalFirewall group
...
timeit { ok( eval "use Net::CloudStack::API ':ExternalFirewall'; 1", 'use statement' ) } 'use took';
explain $@ if $@;
